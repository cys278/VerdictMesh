...
# VerdictMesh Cookbook: Supply Chain Replanning

This example demonstrates how to build an **Enterprise-Grade Supply Chain Crisis Resolution Workflow** using VerdictMesh.
...
Instead of writing a custom aggregator class, this example uses VerdictMesh' built-in `Synthesizer`. We hijack its default behavior by passing a `custom_goal` that forces the LLM to act as the VP of Operations. 
