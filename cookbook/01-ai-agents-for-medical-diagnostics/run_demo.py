"""
=============================================================================
VerdictMesh Demo: Multidisciplinary Medical Diagnostics
=============================================================================
This example demonstrates the core philosophy of the VerdictMesh framework: 
Parallel Isolated Reasoning. 

Instead of relying on a single monolithic prompt or a sequential chain of 
agents (which can lead to logical contamination or "groupthink"), VerdictMesh 
...
Notice that VerdictMesh only requires a standard Python callable for the LLM.
=============================================================================
"""
...
from verdictmesh import Agent, Engine
from verdictmesh.aggregators import Synthesizer # official verdictmesh aggregator
import datetime
...
def nvidia_llm_callable(prompt: str) -> str:
    """
    A standard, model-agnostic callable to pass into the agents and aggregators.
    VerdictMesh doesn't force you into a specific LLM wrapper. You define how 
...
class Cardiologist(Agent):
    def __init__(self):
        super().__init__(
            ...
            llm_callable=nvidia_llm_callable
        )
...
if __name__ == "__main__":
    ...
    print("🩺 VerdictMesh: Running Multidisciplinary Diagnostic...")
