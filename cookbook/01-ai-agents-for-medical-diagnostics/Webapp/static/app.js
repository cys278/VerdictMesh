...
downloadLogBtn.addEventListener('click', () => {
    if (session) {
        // Pointing the window location to this endpoint triggers the browser download.
                    ...
                    if (chunk) {
                        ...
                        if (data.type === "agent_done") {
                            ...
                            if (agentsDoneCount === 4) {
                                ...
                                // Start the team animation after the agent animations.
                                setTimeout(() => {
...
document.querySelectorAll('.agent').forEach(node => {
    node.addEventListener('mouseenter', () => {
        ...
        if (node.classList.contains('done') && node.dataset.result) {
            ...
            // Adjust horizontal bounds to prevent clipping.
